...
class SaleOrder(models.Model):
    ...
    os_descr = fields.Text(string=u"Mensagem para a O.S.")
    msg_financeiro = fields.Text(string=u"Mensagem para o Financeiro")
    ...
    def create_task(self, task, id_ctr):
        ...
        if self.order_line:
            ...
            for line in id_ctr.recurring_invoice_line_ids.product_id:
                vals['description'] = vals['description'] + ' ' + line.name
            os = task.create(vals)
